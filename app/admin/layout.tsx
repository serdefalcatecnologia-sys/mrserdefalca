    ...
    <div className="flex h-screen bg-zinc-100 overflow-hidden font-sans">
      <aside className="flex w-64 flex-col justify-between bg-[#004d3d] text-white">
        ...
        <div className="p-4 border-t border-emerald-800">
          <Link
            href="/login"
            className="flex items-center gap-3 rounded-lg px-4 py-3 text-sm font-medium text-rose-300 hover:bg-emerald-900 transition-colors"
          >
            <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
