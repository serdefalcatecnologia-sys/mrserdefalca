...
- **Generated On**: 2026-09-02 14:22:27 (America/Caracas / GMT-04:00)
...
- [📄 app/admin/comercial/page.tsx](#📄-app-admin-comercial-page-tsx)
- [📄 app/admin/configuracion/page.tsx](#📄-app-admin-configuracion-page-tsx)
- [📄 app/admin/desechos/page.tsx](#📄-app-admin-desechos-page-tsx)
- [📄 app/admin/empleados/registro/page.tsx](#📄-app-admin-empleados-registro-page-tsx)
- [📄 app/admin/empleados/page.tsx](#📄-app-admin-empleados-page-tsx)
...
- **Modified**: 2026-09-01 01:15:42 (America/Caracas / GMT-04:00)
- **MD5**: `f6fa119f07b95ffcbe283188006d0ab3`
- **SHA256**: `4efc88231a6f185be9e5ccbda3a28ec3f04c32cfaf7409755b3e13bb80f2dc8f`
- **Encoding**: ASCII
...
- **Modified**: 2026-09-01 01:32:54 (America/Caracas / GMT-04:00)
- **MD5**: `f04de2fcf3dd3a3ed06ddb7a7a5523c2`
- **SHA256**: `16248fe0caae522d0edb6a3542217f8c247638eb6910f7c4f5abbb80cfa10875`
- **Encoding**: ASCII
...
- **Modified**: 2026-09-02 13:47:58 (America/Caracas / GMT-04:00)
- **MD5**: `f442397cf1ac5ff88066f8328ec92f19`
- **SHA256**: `2b42fb73c269f87fd7b949101d25d75b1344aec508b292f48bd4e20f1968e1c4`
- **Encoding**: ASCII
...
- **Modified**: 2026-08-31 19:25:04 (America/Caracas / GMT-04:00)
- **MD5**: `4ba1f290bada38a91317821bf8f1272a`
- **SHA256**: `0ab643c27adfc4f9921afe0af4532768e44ac310705bff5c1890e59091d3c7dd`
- **Encoding**: UTF-8
  ...
  return (
    <div className="flex h-full flex-col p-8">
      ...
      <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 md:grid-cols-2">
        ...
        <Link href="/admin/comercial" className="block rounded-2xl border border-zinc-200 bg-white p-8 shadow-sm transition-shadow hover:shadow-md">
          <div className="flex flex-col items-center text-center">
            <div className="mb-4 rounded-full bg-emerald-50 p-4 text-emerald-600">
              <svg className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
        ...
        <Link href="/admin/flota" className="block rounded-2xl border border-zinc-200 bg-white p-8 shadow-sm transition-shadow hover:shadow-md">
          <div className="flex flex-col items-center text-center">
            <div className="mb-4 rounded-full bg-emerald-50 p-4 text-emerald-600">
              <svg className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4" />
...
- **Modified**: 2026-09-02 14:21:38 (America/Caracas / GMT-04:00)
- **MD5**: `8544e7912f33979ad314a0588082a9e5`
- **SHA256**: `0d7ab631d5aea52af8f8972bb3ce21a2780f153e6be6c1eeed44b7825a458dad`
- **Encoding**: UTF-8
...
export default function RegistroComercial() {
  ...
  return (
    <div className="max-w-3xl mx-auto p-6 bg-white shadow-xl rounded-xl mt-10 border border-gray-100">
      <h2 className="text-2xl font-bold mb-2 text-emerald-800">Generar Factura / Servicio Comercial</h2>
      <p className="text-sm text-gray-500 mb-6">Complete los datos para emitir la orden de recolección.</p>
      
      <form onSubmit={handleSubmit} className="space-y-5">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          <div>
            <label className="block text-sm font-semibold text-gray-700 mb-1">Cliente / Razón Social *</label>
            <input type="text" required value={cliente} onChange={(e) => setCliente(e.target.value)} placeholder="Nombre de la empresa o persona" className="block w-full border border-gray-300 rounded-lg p-2.5 focus:ring-emerald-500 focus:border-emerald-500 text-sm" />
          </div>
          <div>
            <label className="block text-sm font-semibold text-gray-700 mb-1">Cédula / RIF *</label>
            <input type="text" required value={rif} onChange={(e) => setRif(e.target.value)} placeholder="Ej: J-12345678-9" className="block w-full border border-gray-300 rounded-lg p-2.5 focus:ring-emerald-500 focus:border-emerald-500 text-sm uppercase" />
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          <div>
            ...
            <select value={municipio} onChange={(e) => setMunicipio(e.target.value)} className="block w-full border border-gray-300 rounded-lg p-2.5 focus:ring-emerald-500 focus:border-emerald-500 text-sm">
          ...
          <div>
            ...
            <select value={servicio} onChange={(e) => setServicio(e.target.value)} className="block w-full border border-gray-300 rounded-lg p-2.5 focus:ring-emerald-500 focus:border-emerald-500 text-sm">
        ...
        <div className="bg-emerald-50/50 p-4 rounded-lg border border-emerald-100">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            <div>
              ...
              <input type="number" step="0.01" required value={montoUsd} onChange={(e) => setMontoUsd(e.target.value)} placeholder="0.00" className="block w-full border border-emerald-200 rounded-lg p-2.5 focus:ring-emerald-500 focus:border-emerald-500 text-sm" />
            </div>
            <div>
              <label className="block text-sm font-semibold text-emerald-900 mb-1">Tasa BCV Actual *</label>
              <input type="number" step="0.0001" required value={tasaBcv} onChange={(e) => setTasaBcv(e.target.value)} placeholder="Ej: 36.50" className="block w-full border border-emerald-200 rounded-lg p-2.5 focus:ring-emerald-500 focus:border-emerald-500 text-sm" />
            </div>
            <div>
              <label className="block text-sm font-semibold text-gray-500 mb-1">Total a Pagar (Bs)</label>
              <div className="block w-full border border-gray-200 bg-gray-100 rounded-lg p-2.5 text-sm font-bold text-gray-700">
                Bs. {montoBsCalculado}
              </div>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          <div>
            ...
            <select value={metodoPago} onChange={(e) => setMetodoPago(e.target.value)} className="block w-full border border-gray-300 rounded-lg p-2.5 focus:ring-emerald-500 focus:border-emerald-500 text-sm">
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-3">
              <label className="inline-flex items-center bg-gray-50 px-3 py-2 rounded-lg border border-gray-200 cursor-pointer hover:bg-gray-100">
                ...
                <span className="ml-2 text-sm font-medium text-gray-700">Pendiente</span>
              </label>
              <label className="inline-flex items-center bg-gray-50 px-3 py-2 rounded-lg border border-gray-200 cursor-pointer hover:bg-gray-100">
                ...
                <span className="ml-2 text-sm font-medium text-gray-700">Pagado</span>
              </label>
            </div>
          </div>
        </div>

        <button type="submit" disabled={cargando} className="w-full bg-emerald-700 text-white font-bold py-3 px-4 rounded-lg hover:bg-emerald-800 disabled:opacity-50 transition-colors mt-4 shadow-md">
          {cargando ? "Registrando Factura..." : "Generar Factura Comercial"}
        </button>

        {mensaje && (
          <div className={`p-4 rounded-lg mt-4 text-center font-bold text-sm ${mensaje.includes("Error") ? "bg-red-50 text-red-600" : "bg-emerald-50 text-emerald-700"}`}>
            {mensaje}
          </div>
        )}
      </form>
...
- **Modified**: 2026-09-02 13:44:45 (America/Caracas / GMT-04:00)
- **MD5**: `9456609188692f8bf4c210eb21a66106`
- **SHA256**: `df70ba96b19c207350b361c610b239b84043181977934e7455d7988241b0457e`
- **Encoding**: UTF-8
...
### <a id="📄-app-llave-page-tsx"></a>📄 `app/llave/page.tsx`

**File Info:**
- **Size**: 4.98 KB
- **Extension**: `.tsx`
- **Language**: `typescript`
- **Location**: `app/llave/page.tsx`
- **Relative Path**: `app/llave`
- **Created**: 2026-07-21 20:24:25 (America/Caracas / GMT-04:00)
- **Modified**: 2026-07-21 14:15:20 (America/Caracas / GMT-04:00)
- **MD5**: `689b0def55dc7ef7a131a3f203c5899b`
- **SHA256**: `39422c4346616fc34bb0f4ae464c623ac3ea61b7e6fa4ca2d6e8d1e0a65bbe71`
- **Encoding**: UTF-8
...
### <a id="📄-app-mantenimiento-page-tsx"></a>📄 `app/mantenimiento/page.tsx`

**File Info:**
- **Size**: 1.87 KB
- **Extension**: `.tsx`
- **Language**: `typescript`
- **Location**: `app/mantenimiento/page.tsx`
- **Relative Path**: `app/mantenimiento`
- **Created**: 2026-07-24 02:46:58 (America/Caracas / GMT-04:00)
- **Modified**: 2026-07-24 02:47:02 (America/Caracas / GMT-04:00)
- **MD5**: `ff3a2b243f79d634b317eb4db5912c2a`
- **SHA256**: `d1c73dda24788b18fc5eb2806b4dcd0a986516982a9985388dbe249dcc480afc`
- **Encoding**: UTF-8
...
- **Relative Path**: `app`
- **Created**: 2026-07-21 20:24:25 (America/Caracas / GMT-04:00)
- **Modified**: 2026-07-21 14:14:42 (America/Caracas / GMT-04:00)
...
- **Relative Path**: `app`
- **Created**: 2026-07-21 20:24:25 (America/Caracas / GMT-04:00)
- **Modified**: 2026-09-01 19:35:08 (America/Caracas / GMT-04:00)
- **MD5**: `8be69c7c538fed61af6667693a9154d0`
- **SHA256**: `135cdf5dc1ede9ae9043253492d37ac7beb4a3ef40ad4f8d9fb34a372943f717`
- **Encoding**: UTF-8
...
### <a id="📄-lib-supabase-ts"></a>📄 `lib/supabase.ts`
...
- **Created**: 2026-07-21 20:24:25 (America/Caracas / GMT-04:00)
- **Modified**: 2026-07-21 14:14:42 (America/Caracas / GMT-04:00)
- **MD5**: `75e0a66aac994773f7867f322f460bdc`
- **SHA256**: `57f95573d63ca8fc95c7f0915afae8e8559e85228b53e8e39b560549d4136f2f`
- **Encoding**: ASCII
...
- **Location**: `AGENTS.md`
- **Relative Path**: `root`
- **Created**: 2026-07-21 20:24:17 (America/Caracas / GMT-04:00)
- **Modified**: 2026-07-21 14:14:38 (America/Caracas / GMT-04:00)
...
- **Relative Path**: `root`
- **Created**: 2026-07-21 20:24:13 (America/Caracas / GMT-04:00)
- **Modified**: 2026-07-21 14:14:38 (America/Caracas / GMT-04:00)
...
- **Relative Path**: `root`
- **Created**: 2026-07-21 20:24:17 (America/Caracas / GMT-04:00)
- **Modified**: 2026-08-27 18:19:47 (America/Caracas / GMT-04:00)
- **MD5**: `a4add02c9010ad50adb3b8075b526345`
- **SHA256**: `737a61f1a7845ab544a820a52d2197fc3203dea7189a95af3ce7850fab795d13`
- **Encoding**: ASCII
...
- **Relative Path**: `root`
- **Created**: 2026-07-21 20:24:17 (America/Caracas / GMT-04:00)
- **Modified**: 2026-07-23 13:50:23 (America/Caracas / GMT-04:00)
- **MD5**: `a0041cbfdbcca68722330c9170372d12`
- **SHA256**: `55b2b32a2549c26608891cdc78a0f7a4ce7e8d9f3fe20a4cc3c014a0c3848794`
- **Encoding**: ASCII
...
- **Location**: `README.md`
- **Relative Path**: `root`
- **Created**: 2026-07-21 20:24:18 (America/Caracas / GMT-04:00)
- **Modified**: 2026-07-21 14:14:38 (America/Caracas / GMT-04:00)
...
- **Created**: 2026-07-21 20:24:17 (America/Caracas / GMT-04:00)
- **Modified**: 2026-07-21 14:14:38 (America/Caracas / GMT-04:00)
- **MD5**: `02fc19ad21338c2ab820a70136310db4`
- **SHA256**: `be18523b23b78b6e1a876ddd107d330f0168bddf09d751b57e0b5edce69c66f3`
- **Encoding**: ASCII
