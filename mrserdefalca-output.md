...
- **Generated On**: 2026-09-22 17:12:00 (America/Caracas / GMT-04:00)
...
- [📄 app/api/actualizar-usuario/route.ts](#📄-app-api-actualizar-usuario-route-ts)
- [📄 app/api/crear-usuario/route.ts](#📄-app-api-crear-usuario-route-ts)
- [📄 app/api/eliminar-usuario/route.ts](#📄-app-api-eliminar-usuario-route-ts)
...
- **Modified**: 2026-09-11 12:46:20 (America/Caracas / GMT-04:00)
- **MD5**: `193700cc9f8f1ff8b1355435ffb1c2ff`
- **SHA256**: `3eff44b3163b438d2af2672d399eff2ebd69c094d8054d2dc141f0fb4c738912`
- **Encoding**: UTF-8
...
- **Modified**: 2026-09-22 15:00:59 (America/Caracas / GMT-04:00)
- **MD5**: `9ec6db4766ee51e6f7ee073e6c851cc9`
- **SHA256**: `bc721432e71504c8d7398537d2bce8cb48b15a8ea153fe89024ebdb9e435db9a`
- **Encoding**: ASCII
...
- **Modified**: 2026-09-22 15:13:08 (America/Caracas / GMT-04:00)
- **MD5**: `a63519232f97514094afd00124a216b7`
- **SHA256**: `e613aa8e6197c88d2fde3d676c2ad9dd67e905db422e89a0b7a9bd6f2c97900b`
- **Encoding**: ASCII
...
- **Modified**: 2026-09-22 16:06:14 (America/Caracas / GMT-04:00)
- **MD5**: `3b8c2e4142c440be0e517f0b267ed2b9`
- **SHA256**: `abd5131bd13fd08669e9843d5b2d565396389754a61bac85c09a5f3587e52d3f`
- **Encoding**: UTF-8
  ...
  const modulos = [
    {
      ...
      href: "/admin/empleados/registro",
      icono: (
        <svg className="w-8 h-8 text-[#008f5d] mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
### <a id="📄-app-api-actualizar-usuario-route-ts"></a>📄 `app/api/actualizar-usuario/route.ts`

**File Info:**
- **Size**: 1.65 KB
- **Extension**: `.ts`
- **Language**: `typescript`
- **Location**: `app/api/actualizar-usuario/route.ts`
- **Relative Path**: `app/api/actualizar-usuario`
- **Created**: 2026-09-22 14:46:38 (America/Caracas / GMT-04:00)
- **Modified**: 2026-09-22 14:53:58 (America/Caracas / GMT-04:00)
...
- **Modified**: 2026-09-22 14:53:39 (America/Caracas / GMT-04:00)
...
### <a id="📄-app-api-eliminar-usuario-route-ts"></a>📄 `app/api/eliminar-usuario/route.ts`

**File Info:**
- **Size**: 1.5 KB
- **Extension**: `.ts`
- **Language**: `typescript`
- **Location**: `app/api/eliminar-usuario/route.ts`
- **Relative Path**: `app/api/eliminar-usuario`
- **Created**: 2026-09-22 14:51:31 (America/Caracas / GMT-04:00)
- **Modified**: 2026-09-22 14:51:59 (America/Caracas / GMT-04:00)
- **MD5**: `be49ccd7daa6076c8a7b77400b4cea97`
- **SHA256**: `29a7fedb50ae3126c89198d5c8361a4c37cc86c0e537c7c62b625afad2569124`
- **Encoding**: ASCII
...
- **Modified**: 2026-09-22 17:06:36 (America/Caracas / GMT-04:00)
- **MD5**: `2b66778b99be7eb92212a6d7f4c525ab`
- **SHA256**: `0bda2077163a38f5931426935d718a4a3a5f6b769c744b2eb867b75b2b1e9523`
- **Encoding**: UTF-8
...
- **Modified**: 2026-09-22 17:07:22 (America/Caracas / GMT-04:00)
- **MD5**: `00fcf84a1bdb963e37c8f357bd227ff0`
- **SHA256**: `1dfdd31c9ea5764ab7230dacecdc38c925b7b9693874313c0b48dd8f4ce1f61c`
- **Encoding**: ASCII
...
- **Modified**: 2026-09-22 17:11:59 (America/Caracas / GMT-04:00)
- **MD5**: `4283bbed0f06e35da509ba369bb4d51a`
- **SHA256**: `52d65f70edfaa1f1b7386725f0cb419f1136ff809c83ea7134585310cf5da22d`
- **Encoding**: ASCII
...
- **Relative Path**: `app`
- **Created**: 2026-07-21 20:24:25 (America/Caracas / GMT-04:00)
- **Modified**: 2026-09-22 15:36:48 (America/Caracas / GMT-04:00)
- **MD5**: `76ebe3f45cf387706d18feda72ba7011`
- **SHA256**: `0decc5300836f43cccd362da6ed1113e30910c41a904ecf633c73a055f2c19f8`
- **Encoding**: UTF-8
      ...
      if (authData.user) {
        ...
        startTransition(() => {
          if (rol === 'administrador') {
            ...
            setErrorMsg(`El rol "${rol}" no es válido.`)
    ...
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-[340px] p-6 relative z-10">
        ...
        <div className="text-center mb-5">
          <h1 className="text-xl font-bold text-green-800 tracking-wide mb-0.5">Portal SERDEFALCA</h1>
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          {errorMsg && (
            <div className="bg-red-50 text-red-600 text-[11px] p-2.5 rounded-lg flex items-center gap-2 border border-red-100">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 shrink-0" viewBox="0 0 20 20" fill="currentColor"><path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM8.707 7.293a1 1 0 00-1.414 1.414L8.586 10l-1.293 1.293a1 1 0 101.414 1.414L10 11.414l1.293 1.293a1 1 0 001.414-1.414L11.414 10l1.293-1.293a1 1 0 00-1.414-1.414L10 8.586 8.707 7.293z" clipRule="evenodd" /></svg>
              {errorMsg}
            </div>
          )}
...
### <a id="📄-lib-supabase-admin-ts"></a>📄 `lib/supabase-admin.ts`
...
- **Relative Path**: `lib`
- **Created**: 2026-09-16 16:03:35 (America/Caracas / GMT-04:00)
- **Modified**: 2026-09-16 16:03:55 (America/Caracas / GMT-04:00)
- **MD5**: `63e71731eb03ef8ef72027338fe6e746`
- **SHA256**: `c7ec0d21f706b66a3eb70ac3a8b1af2b523a73fd52c19eac1fbb81e9b5449816`
- **Encoding**: ASCII
...
- **Relative Path**: `lib`
- **Created**: 2026-07-21 20:24:25 (America/Caracas / GMT-04:00)
- **Modified**: 2026-09-22 17:07:36 (America/Caracas / GMT-04:00)
- **MD5**: `285330011661eb1c4669efe634f6bd59`
- **SHA256**: `b50b91a078120108e121f35e7c4231f3f66a03faf2ea829f347e1aac766e4f47`
- **Encoding**: ASCII
